...
class OtpDocumentation 
{
     ...
     *     description="Send OTP to the user's email for account verification. This method generates a random OTP code and sends it to the user's email for verification purposes.",
     *     tags={"OTP"},
     *     security={{"bearerAuth":{}}},
     *     @OA\RequestBody(
     *         required=true,
     ...
     *     description="Send OTP to the user's email for password reset. This method generates a random OTP code and sends it to the user's email for resetting their password.",
     *     tags={"OTP"},
     *     @OA\RequestBody(
     *         required=true,
     *         @OA\JsonContent(
